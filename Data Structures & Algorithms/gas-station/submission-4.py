class Solution:
    def canCompleteCircuit(self, gas: List[int], cost: List[int]) -> int:
        ...
        for i in range(len(gas)):
            ...
            # if it never dips below 0 it does work. we just need to find the first case where total goes all the way to the end WE DONT CARE ABOUT LOOPING BACK SINCE IF THE TOTAL GETS FUCKED BEFORE IT REACHES END ITS OVER IT ALREADY DOESNT WORK AND IF IT CAN REACH THE END THAT MEANS THAT WE ARE GOOD -> since that will be the ONLY solution
