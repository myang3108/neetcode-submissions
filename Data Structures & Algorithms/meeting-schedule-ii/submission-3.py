...
class Solution:
    def minMeetingRooms(self, intervals: List[Interval]) -> int:
        ...
        # only care when it arrives at the door (intervals[i].start). If arrive at the door before the room is empty (intervals[i].start < free_rooms[0]), they cannot go in, and must open a new room.
